...
- `src/btx_lib_list/`: Python package exposing placeholders for testing.
...
- On a version bump, update only `pyproject.toml` and the `CHANGELOG.md` entry; do not edit `src/btx_lib_list/__init__conf__.py` for versioning.
