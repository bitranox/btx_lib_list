Hier ist dein Konzept – **unverändert in Struktur & Inhalt**, aber mit dem Bibliotheksnamen **`btx_lib_list`** durchgängig aktualisiert.
...
* **Dump-API:** `btx_lib_list.dump(format="text"|"json"|"html", path=None)`
...
**Modulname:** `btx_lib_list`

```python
import btx_lib_list as log
...
>
> * Minimal: `pip install btx_lib_list`
> * Mit Rich: `pip install btx_lib_list[rich]`
> * Mit Graylog: `pip install btx_lib_list[gelf]`
> * Komplett: `pip install btx_lib_list[rich,gelf,journald,eventlog]`
...
Wenn du willst, liefere ich dir als Nächstes ein kleines **Starter-Skeleton** für `btx_lib_list` (Package-Layout, Handler-Stubs, Rich-Theme, HTML-Dump) – ready to run.
