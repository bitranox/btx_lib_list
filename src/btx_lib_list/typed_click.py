...
Wrapping the affected decorators here behind explicit, fully-known signatures
keeps the rest of the CLI layer strict-clean without disabling the rule. This
...
# collected into a list of shared options.
